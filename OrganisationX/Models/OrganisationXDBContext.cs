        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Department>(entity =>
            {
                ...
                entity.HasOne(d => d.DepartmentNavigation)
                    ...
                    .HasConstraintName("FK_Department_AspNetUsers");
            });
            ...
            modelBuilder.Entity<Education>(entity =>
            {
                ...
                entity.HasOne(d => d.EducationNavigation)
                    ...
                    .HasForeignKey<Education>(d => d.EducationId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<WorkRecord>(entity =>
            {
                ...
                entity.HasOne(d => d.WorkR)
                    .WithOne(p => p.WorkRecord)
                    .HasForeignKey<WorkRecord>(d => d.WorkRid)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_WorkRecord_AspNetUsers");
            });
